...
export const useReminderStore = create<ReminderState>((set, get) => ({
  reminders: [
    { id: '1', title: 'Buy groceries', description: 'Milk, Eggs, Bread, Cheese', date: 'December 17, 1995 03:24:00' },
    { id: '2', title: 'Call mom', description: 'Wish her a happy birthday', date: 'December 17, 1995 03:24:00' },
    {
      id: '3',
